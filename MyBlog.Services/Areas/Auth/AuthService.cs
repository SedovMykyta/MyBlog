...
public class AuthService : IAuthService
{
    ...
    public AuthService(IUserService userService, IConfiguration config, IEncryptDecryptManager encryptDecrypt)
    {
    ...
    private async Task<User> AuthenticateAsync(UserDtoLogin userLogin)
    {
        ...
        if (userLogin.Password != _encryptDecrypt.Decrypt(user.Password))
        {
