...
using MyBlog.Service.Areas.Articles.Validators;
...
builder.Services.AddTransient<IParseJwtToken, ParseJwtToken>();

builder.Services.AddAutoMapper(typeof(UserMappingProfile), typeof(ArticleDtoInputValidator));
